      ...
      <div className="grid grid-cols-1 gap-2">
        {options.map((option, idx) => (
          <button
            ...
            className={`p-3 sm:p-4 rounded-xl sm:rounded-2xl border transition-all cursor-pointer flex justify-between items-center ${
          ...
          >
            ...
            {selectedValue === option && (
              <div className="w-2 h-2 bg-[#3772FE] rounded-full shadow-glow flex-shrink-0"></div>
            )}
          </button>
        ))}
      </div>
